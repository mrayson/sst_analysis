...
#YEAR=$1
#$PYTHON -u download_sst.py -s $YEAR,1,1,0,0 -d 31 > sst_"$YEAR"01.out &
#$PYTHON -u download_sst.py -s $YEAR,2,1,0,0 -d 28 > sst_"$YEAR"02.out &
#$PYTHON -u download_sst.py -s $YEAR,3,1,0,0 -d 31 > sst_"$YEAR"03.out &
#$PYTHON -u download_sst.py -s $YEAR,4,1,0,0 -d 30 > sst_"$YEAR"04.out &
